        ...
        <form action="#" style="display: inline-block;">
            <div class="form-group">
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Ваш номер телефона для связи: <strong><?= $order['phone']?></strong></li>
                    <li class="list-group-item">Адрес доставки: <strong><?= $order['city']?>, <?= $order['address']?></strong></li>
            ...
            <div class="form-group">
               Вам на почту выслана информация о заказе. Спасибо за Ваш заказ!!!.
            </div>
            <div class="form-group">
