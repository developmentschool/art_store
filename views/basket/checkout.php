            ...
            <div class="row">
                <div class="col-md-6 pt-3" style="border: 5px solid transparent;">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label class="label" for="exampleInputFirstName1">First Name <span
                    ...
                    <div class="form-group">
                        <label class="label" for="exampleInputAddress1">Street address <span
                                    class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label class="label" for="exampleInputPhone1">Phone Numer <span
                                            class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="exampleInputText1"
                                  placeholder="Special notes for delivery"></textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="p-3" style="border: 5px solid #eeeeee;">
                        ...
                        <div class="form-group form-check">
                            ...
                            <label class="form-check-label" for="exampleCheck2">I have read and agree to the website
