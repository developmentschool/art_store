...
?>
    ...
    <div class="section-elements">
        <div class="row">
            <?php
            echo $this->render('categoryBlock', ['cats' => \app\services\CategoryService::getRandomCategory()]);
            ?>
        </div>
    ...
    <div class="section-elements">
        ...
        <div class="row">
            <?php
            echo $this->render('productsBlock', ['products' => \app\services\ProductService::getNewProducts()]);
            ?>
    ...
    <div class="section-elements">
        ...
        <div class="row">
            ...
            echo $this->render('productsBlock',
                ['products' => \app\services\ProductService::getNewsOtherProducts()])
            ?>
        </div><!-- .section-elements end -->
